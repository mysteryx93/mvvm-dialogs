...
namespace MvvmDialogs.Core
{
    ...
    /// </summary>
    public class DialogService : DialogServiceBase<Window>
    {
        /// <summary>
        ...
        public DialogService(
            ...
            :
            base(dialogFactory ?? new ReflectionDialogFactory(), dialogTypeLocator ?? new NamingConventionDialogTypeLocator())
        {
